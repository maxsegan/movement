...
\author{Max Segan%
\thanks{Columbia University. Correspondence: \texttt{m.segan@columbia.edu}.}}
...
\textbf{Our approach.} We train a closed-loop humanoid VLAM entirely from \emph{human video data}, which contains rich demonstrations of full-body motion. Our contributions are:
