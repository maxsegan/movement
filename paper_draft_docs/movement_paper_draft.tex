...
\author{Max Segan%
\thanks{Correspondence: \texttt{max@segan.com}}}
...
We thank the authors of YOLOv8, ByteTrack, ViTPose, MotionAGFormer, and Qwen3-VL for releasing pretrained models and code, the Kinetics-700 team for making the dataset available, and Anthropic for Claude Code, which was used to build, run, and tune the data pipeline and training infrastructure for this work.
